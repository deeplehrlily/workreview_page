...
export default function CardNewsWide() {
  return (
    <div className="w-[1920px] h-[1080px] relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#E8F8FF] via-[#F0FBFF] to-[#E0F4FF]">
      ...
      <div className="relative w-1/2 h-full flex items-center justify-center">
        <div className="relative w-96 h-96">
          ...
          >
            <div className="w-32 h-32 bg-white rounded-[2.5rem] shadow-[0_25px_50px_rgba(91,222,240,0.3)] flex items-center justify-center backdrop-blur-sm">
              <GiftIcon />
            </div>
          </motion.div>
          ...
          >
            <div className="w-48 h-48 bg-gradient-to-br from-[#5BDEF0] to-[#4AC8E0] rounded-full flex items-center justify-center">
              <CenterSparkleIcon />
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-1/2 h-full flex flex-col items-center justify-center px-16">
        {/* Special event badge */}
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#5BDEF0]/20 to-[#4AC8E0]/20 text-[#5BDEF0] px-8 py-4 rounded-full text-2xl font-bold mb-8 border border-[#5BDEF0]/30">
          ✨ 특별 이벤트
        </div>
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-700">리뷰 작성시 경품 증정</h2>
        </div>

        {/* Description */}
        <p className="text-gray-600 text-center mb-8 text-xl max-w-lg">
          보상은 선착순으로 제공되니 지금 바로 작성하러 가세요!
        </p>

        {/* Reward badge */}
        <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#5BDEF0]/15 to-[#4AC8E0]/15 text-[#5BDEF0] px-8 py-4 rounded-full text-lg font-bold mb-12 border border-[#5BDEF0]/30">
          ⚡ 모든 참여자에게 100% 보상 지급
        </div>

        {/* CTA Button */}
        <motion.button
          className="px-16 py-5 bg-gradient-to-r from-[#5BDEF0] to-[#4AC8E0] text-white font-bold rounded-full shadow-lg text-2xl mb-8"
